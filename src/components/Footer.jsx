...
const RESOURCE_LINKS = [
  { to: "/airport-transfer", label: "Kochi Airport EV Taxi" },
  { to: "/kochi-infopark", label: "Infopark Corporate Cabs" },
  { to: "/smartcity-kakkanad", label: "SmartCity Corporate Cabs" },
  { to: "/blog", label: "Insights & Guides" },
];
